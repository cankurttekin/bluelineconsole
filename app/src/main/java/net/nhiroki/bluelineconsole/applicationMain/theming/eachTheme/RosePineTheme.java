...
public class RosePineTheme extends BaseTheme {
    ...
    public void apply(BaseWindowActivity activity) {
        ...
        activity.setTheme(activity.isHomeActivity() ? R.style.AppThemeRosePineHome : R.style.AppThemeRosePine);
    ...
    public void applyAccentColor(BaseWindowActivity activity, @ColorInt int color) {
        ...
        activity.getTheme().resolveAttribute(R.attr.bluelineconsoleAccentColor, accentColorFromTheme, true);
    ...
    public CharSequence getThemeTitle(Context context) {
        return context.getString(R.string.theme_name_rosepine);
    }
