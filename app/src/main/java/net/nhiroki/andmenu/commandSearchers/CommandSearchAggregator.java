package net.nhiroki.andmenu.commandSearchers;

import android.content.Context;

import net.nhiroki.andmenu.commandSearchers.eachSearcher.ApplicationCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.CalendarCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.CalculatorCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.ColorDisplayCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.ContactSearchCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.DateCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.FactorCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.HelpCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.NetUtilCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.PreferencesCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.SearchEngineCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.SearchEngineDefaultCommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.URICommandSearcher;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.WidgetCommandSearcher;
import net.nhiroki.andmenu.dataStore.persistent.HomeScreenSetting;
import net.nhiroki.andmenu.interfaces.CandidateEntry;
import net.nhiroki.andmenu.interfaces.CommandSearcher;
import net.nhiroki.andmenu.wrapperForAndroid.AppWidgetsHostManager;
