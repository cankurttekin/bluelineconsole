...
import net.nhiroki.andmenu.BuildConfig;
import net.nhiroki.andmenu.R;
import net.nhiroki.andmenu.applicationMain.lib.EditTextConfigurations;
import net.nhiroki.andmenu.applicationMain.theming.AppThemeDirectory;
import net.nhiroki.andmenu.commandSearchers.lib.StringMatchStrategy;
import net.nhiroki.andmenu.commands.urls.WebSearchEngine;
import net.nhiroki.andmenu.commands.urls.WebSearchEnginesDatabase;
import net.nhiroki.andmenu.widget.LauncherWidgetProvider;
