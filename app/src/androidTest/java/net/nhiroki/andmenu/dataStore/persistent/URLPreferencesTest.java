package net.nhiroki.andmenu.dataStore.persistent;
...
public class URLPreferencesTest extends AndroidTestCase {
    ...
    public void urlPreferencesUpgradeFrom_1_2_5_Test() {
        ...
        net.nhiroki.andmenu.dataStore.persistent.oldVersions.URLPreferences_1_2_5 oldVersionInstance =
                net.nhiroki.andmenu.dataStore.persistent.oldVersions.URLPreferences_1_2_5.getInstance(this.getContext());
