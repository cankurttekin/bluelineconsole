package net.nhiroki.andmenu.dataStore.cache;
...
import net.nhiroki.andmenu.dataStore.cache.oldVersions.ApplicationInformationCache_1_2_5;
...
public class ApplicationInformationCacheTest extends AndroidTestCase {
    ...
    public void applicationInformationCacheBasicFunctionTest() {
        ...
        apps.add(new ApplicationInformation("net.nhiroki.andmenu-test-1", "ja_JP", 2, "Test App", true));
        apps.add(new ApplicationInformation("net.nhiroki.andmenu-test-2", "en_GB", 3, "Test App 2", false));
