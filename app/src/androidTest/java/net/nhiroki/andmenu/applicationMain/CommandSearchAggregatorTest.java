package net.nhiroki.andmenu.applicationMain;
...
import net.nhiroki.andmenu.commandSearchers.CommandSearchAggregator;
import net.nhiroki.andmenu.commandSearchers.eachSearcher.ContactSearchCommandSearcher;
import net.nhiroki.andmenu.commands.urls.WebSearchEnginesDatabase;
import net.nhiroki.andmenu.dataStore.cache.ApplicationInformationCache;
import net.nhiroki.andmenu.dataStore.persistent.URLEntry;
import net.nhiroki.andmenu.dataStore.persistent.URLPreferences;
